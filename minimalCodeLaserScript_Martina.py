...
from Elements.CompositeShapes_Martina import LaseredFiducial
...
if __name__ == '__main__':
    ...
    parameters = {'xStart': 0,
                  ...
                  'speedP3': 50000,
                  'yStartP3': 6950,
                  'distanceBetweenFirstAndSecondP3Line': 100,
                  'distanceBetweenSecondAndThirdP3Line': 340,
                  'distanceBetweenSecondAndFourthP3Line': 400,
                  'yCutOff':0,
                  'powerCutOff': 8,
                  'freqCutOff': 20,
                  'speedCutOff': 50000,
                  'distanceBetweenCells': 7000,
                  'numberOfCells': 5,
                  'fiducialX':-2500,
                  'fiducialY':-2500,
                  'NumberofP2Lines':5}
